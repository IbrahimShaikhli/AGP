...
function NavBar() {
  ...
  return (
    <div>
      <nav className="fixed w-full top-0 left-0 right-0 z-50 bg-white">
          ...
          <div>
            ...
            >
              <ul className="h-screen md:h-auto items-center justify-center md:flex py-5 px-5">
                <li className="pb-6 text-lg text-gray-600 py-2 px-6 text-center border-b-2 md:border-b-0 relative group hover:text-blue-900">
                ...
                <li className="pb-6 text-lg text-gray-600 py-2 px-6 text-center border-b-2 md:border-b-0  duration-300 relative group hover:text-blue-900">
